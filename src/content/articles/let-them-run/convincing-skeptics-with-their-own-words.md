...
Here's where it gets interesting. I have a system I built called [Flow OS](https://thecognitiveshift.com/training/). Think of it as an AI second brain -- a custom Claude Code harness with persistent memory, integrated tools, and a compound learning loop. Every project I do makes the next one faster. Every conversation gets captured. Every pattern gets extracted.
...
So I asked Flow OS to do what it does best: parallel research at scale.
...
Within five minutes, I had 29 research-backed data points.
...
I fed all of this into a single source document, uploaded it to NotebookLM, and generated a nine-slide deck with a narrative arc: the pattern, the frame error, the evidence, the psychology, his industry's movement, and the compounding cost of waiting.

While the slides cooked, I wrote the email.

## The email that wrote itself

I kept it short. Started with Marcus's own question: *"Aside from Codex coding, what other business function do I need AI for?"*

Then I quoted his February email back to him. His own words proving he'd already answered his own question.
...
## The punchline I'm saving

Here's the part I haven't told Marcus yet.

When he responds -- and I think he will, because nobody ignores being quoted back to themselves -- I'm going to tell him the email he just read was drafted by AI. The research was conducted by AI. The slides were generated by AI. The whole thing, from "read my emails with Marcus" to "email sent with research-backed slide deck attached," took about ten minutes.

Not because AI replaced my thinking. Because it amplified it.

I knew what the argument should be. I knew the insight from my client was transferable. I knew Marcus's contradiction was the hook. All of that is judgment. All of that is human.

The AI just made it possible to do in ten minutes what would otherwise take a full day. And that's the thing Marcus doesn't see yet. Not because he's wrong about AI. Because he's measuring it against the wrong yardstick.

The question isn't whether AI works for him. He already proved it does.

The question is how long he'll keep pretending it only works for two things.
