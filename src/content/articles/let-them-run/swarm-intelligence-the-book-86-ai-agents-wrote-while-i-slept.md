...
A dispatcher agent decomposed my intent into structure. My messy description of wanting a "cross-domain tactical field guide on agentic swarms" became a structured outcome with a clear success criteri I had opinions on how it should sequence the work. So I just spoke them into a "how" section which generates an optimized design.md, detailing how to approach the research domains, synthesize findings, write chapters organized around a unifying framework, review everything, assemble the final product. It's by no means bullet proof. Most human work isn't. Yet humans manage to write amazing books. There's a deep insight there worth reading twice. Because it's baked into how FLOW works.
